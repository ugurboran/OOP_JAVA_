...
public class MyHashMap<K, V> implements MyMap<K, V> {
	...
	private int trimToPowerOf2(int initialCapacity) {
		int capacity = 1; // throw throw throw
		while (capacity < initialCapacity) {
			capacity <<= 1; // throw throw throw
		}
		// throw throw throw
		return capacity; // throw throw throw
	}

	// Remove all entries from each bucket
	private void removeEntries() {
		for (int i = 0; i < capacity; i++) {
			if (table[i] != null) { // throw throw throw
				table[i].clear(); // throw throw throw
			}
		}
	}
	...
	// while while while
	@Override
	public String toString() { // for for for for for for for for for for for for for for for for for for
